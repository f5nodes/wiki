...
#### Pro-nodes:
```bash
http://dymension.testnet.api.node75.org:1383
```
...
#### Pro-nodes:
```bash
http://dymension.testnet.rpc.node75.org:23787
```
...
#### Pro-nodes:
```bash
dymension.testnet.grpc.node75.org:9740
```
