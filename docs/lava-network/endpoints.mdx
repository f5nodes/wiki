...
#### F5 Nodes:
```bash
https://lava-testnet-api.f5nodes.com
```
...
#### [Noders]Team:
```bash
http://lava.api.nodersteam.com:13317
```
...
#### F5 Nodes:
```bash
https://lava-testnet-rpc.f5nodes.com
```
...
#### [Noders]Team:
```bash
http://lava.rpc.nodersteam.com:13657
```
...
#### STAVR:
```bash
http://lava.rpc.t.stavr.tech:198
```
...
#### F5 Nodes:
```bash
lava-testnet-grpc.f5nodes.com:9290
```
...
#### [Noders]Team:
```bash
http://lava.grpc.nodersteam.com:13656
```
...
#### STAVR:
```bash
http://lava.grpc.t.stavr.tech:179
```
