...
export let endpoints = [
	...
	'https://raw.githubusercontent.com/nodersteam/cosmos-adrbook/main/lava/addrbook.json',
 	'https://ss-t.lava.nodestake.top/addrbook.json',
 	'https://snapshots.polkachu.com/testnet-addrbook/lava/addrbook.json',
	'https://raw.githubusercontent.com/obajay/nodes-Guides/main/Projects/Lava_Network/addrbook.json',
];
