...
`https://side-testnet.rpc.kjnodes.com:443`,
`https://rpc-testnet-side.nodeist.net:443`,
`https://rpc.side.aknodes.net:443`,
`https://side-testnet-rpc.stake-town.com:443`,
`https://rpc.cosmos.directory:443/side`,
`https://side-testnet-rpc.itrocket.net:443`,
`https://rpc-t.side.nodestake.org:443`,
];
